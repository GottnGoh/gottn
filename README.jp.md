...
## 目次
### [Step 1: 設計図からGottnオブジェクトを作る。](#Step-1-設計図からGottnオブジェクトを作る。)
### [Step 2: Gottnオブジェクトのメンバ](#Step-2-Gottnオブジェクトのメンバ)
### [Step 3: 再描画](#Step-3-再描画)
### [Step 4: Gottnオブジェクトにメソッドを追加する。](#Step-4-Gottnオブジェクトにメソッドを追加する。)
### [Step 5: イベント処理](#Step-5-イベント処理)
### [Step 6: Gottnオブジェクトの入れ子](#Step-6-Gottnオブジェクトの入れ子)
### [Step 7: 描画後の処理](#Step-7-描画後の処理)
